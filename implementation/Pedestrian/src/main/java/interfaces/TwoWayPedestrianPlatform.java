...
/**
 * Interface for TwoWayPlatform objects.
 * TwoWayPlatform are more complex platforms which can have up to two pair platforms accessible.
 * TwoWayPlatform can also be seen as Corner Platform as they will be used as corners of a crossing.
 *
