...
### Strategy and state pattern composition - The traffic lights with different light behaviours and states (Niklas)
...
The GUI observes specific components of individual traffic lights - part of the business logic. Whenever a light changes it updates automatically the presentation logic module about the change. This way we can easily request changes within the GUI, that are applied in the business logic module and then announched to the GUI. 
